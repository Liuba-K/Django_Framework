...
SERVER_IP_ADDR = "127.0.0.1" #Сейчас локальный, а нужно IP сайта загрузки сервера
...
class LoadTestingBraniacLMS(HttpUser):
    ...
    def test_some_pages_open(self):
        ...
        self.client.get(f"http://{SERVER_IP_ADDR}/mainapp/courses/1/") #возможно подправить надо путь
        # Authapp
