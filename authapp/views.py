...
from django.contrib.auth.mixins import LoginRequiredMixin, UserPassesTestMixin #change
#from django.http.response import HttpResponseRedirect
from django.urls import reverse_lazy
from django.utils.safestring import mark_safe
from django.utils.translation import gettext_lazy as _ # используют для переводов
from django.views.generic import CreateView, UpdateView #change

from authapp import forms # new
...
class ProfileEditView(UserPassesTestMixin, UpdateView):
    model = get_user_model()
    form_class = forms.CustomUserCreationForm #error CustomUserChangeForm
