...
from django.views.generic import TemplateView, CreateView, DeleteView, DetailView, ListView, UpdateView, View
...
class LogDownloadView(UserPassesTestMixin, View):
    ...
    def get(self, *args, **kwargs):
        return FileResponse(open(settings.LOG_FILE, "rb")) #читает бинарные файлы
